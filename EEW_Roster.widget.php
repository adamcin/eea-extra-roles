 ...
 * @since 2.0
 */
class EEW_Roster extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        parent::__construct(
            ...
            array(
                'width' => 300,
                'height' => 350,
                'id_base' => 'ee-roster-widget',
                'classname' => 'ee-roster-widget'
            )
        );
    }
    ...
    public function widget($args, $instance)
    {
        ...
        if (isset($post->post_content)) {
            if (strpos($post->post_content, '[ESPRESSO_CALENDAR') === false) {
                ...
                if (! EE_Registry::instance()->modules->EED_Roster instanceof EED_Roster) {
                    EE_Registry::instance()->modules->EED_Roster = new EED_Roster();
                }
                echo EE_Registry::instance()->modules->EED_Roster->display_roster($attributes);
